...
class EvaluateGateStatusTest(testing_config.CustomTestCase):
    ...
    def test_get_template_data__no_updates_needed(self):
        ...
        gate_1 = Gate(
            feature_id=1, state=Gate.PREPARING, gate_type=1, stage_id=11
        )
        gate_1.put()
        actual = self.handler.get_template_data()
        self.assertEqual(actual, '0 Gate entities updated.')
...
class AssociateOTsTest(testing_config.CustomTestCase):
    ...
    def test_associate_ots(self, mock_ot_client):
        ...
        self.assertEqual(
            msg,
            '3 Stages updated with trial data.\n1 extension requests cleared.',
        )
        ...
        self.assertEqual(
            ot_1.intent_thread_url, 'https://example.com/experiment'
        )
...
class CreateOriginTrialsTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.ot_stage_2 = Stage(
            ...
            feature_id=2,
            stage_type=250,
            ot_display_name='Example Trial 2',
            ...
            ot_description='OT description2',
            ot_has_third_party_support=True,
            ot_is_deprecation_trial=False,
            ot_setup_status=core_enums.OT_READY_FOR_CREATION,
        )
        ...
        self.ot_stage_3 = Stage(
            ...
            feature_id=3,
            stage_type=450,
            ot_display_name='Example Trial 3',
            ot_owner_email='feature_owner2@google.com',
            ...
            ot_description='OT description3',
            ot_has_third_party_support=True,
...
class ActivateOriginTrialsTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.ot_stage_2 = Stage(
            ...
            stage_type=250,
            ot_display_name='Example Trial 2',
            origin_trial_id='444555666',
            ot_activation_date=date(2020, 2, 15),
            ot_setup_status=core_enums.OT_CREATED,
            ot_owner_email='feature_owner2@google.com',
            ot_chromium_trial_name='ExampleTrial2',
            milestones=MilestoneSet(desktop_first=200, desktop_last=206),
        ...
        self.ot_stage_3 = Stage(
            ...
            stage_type=450,
            ot_display_name='Example Trial 3',
            origin_trial_id='777888999',
            ot_activation_date=date(2024, 1, 1),
            ot_setup_status=core_enums.OT_CREATED,
            ot_owner_email='feature_owner2@google.com',
            ot_chromium_trial_name='ExampleTrial3',
            milestones=MilestoneSet(desktop_first=200, desktop_last=206),
    ...
    def test_activate_trials(
        ...
        result = self.handler.get_template_data()
        self.assertEqual(
            '2 activation(s) successfully processed and 0 '
            'activation(s) failed to process.',
            result,
        )
    ...
    def test_activate_trials__failed(
        ...
        result = self.handler.get_template_data()
        self.assertEqual(
            '0 activation(s) successfully processed and 2 '
            'activation(s) failed to process.',
            result,
        )
        # Activation requests should have been sent.
...
class DeleteEmptyExtensionStagesTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.extension_stage_1 = Stage(
            feature_id=1,
            stage_type=151,
            experiment_extension_reason='idk',
        ...
        self.gate_5 = Gate(
            feature_id=1,
            stage_id=self.extension_stage_5.key.integer_id(),
            gate_type=core_enums.GATE_API_EXTEND_ORIGIN_TRIAL,
            state=Vote.NA,
        )
        self.gate_5.put()
...
class BackfillShippingYearTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.stage_3_1 = Stage(
            feature_id=33333, milestones=MilestoneSet(desktop_first=126)
        )
        self.stage_4_1 = Stage(
            feature_id=44444, milestones=MilestoneSet(desktop_first=200)
        )
...
class BackfillGateDatesTest(testing_config.CustomTestCase):
    ...
    def test_calc_resolved_on__not_resolved(self):
        ...
        self.assertIsNone(self.handler.calc_resolved_on(self.gate, []))
...
class FetchWebdxFeatureIdTest(testing_config.CustomTestCase):
    ...
    def test_fetch_webdx_feature_ids__success(self, mock_list_features):
        ...
        mock_list_features.side_effect = [feature_page_1, feature_page_2]
...
class SendManualOTCreatedEmailTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.ot_stage = Stage(
            ...
            feature_id=1,
            stage_type=150,
            ot_owner_email='owner1@google.com',
            ot_emails=['editor1@example.com'],
            ot_display_name='Example trial',
            ot_activation_date=date(2020, 1, 1),
        )
        self.ot_stage.put()
    ...
    def test_send__no_activation_date(self, mock_enqueue):
        ...
        result = self.handler.get_template_data(stage_id=self.ot_stage_id)
        self.assertEqual(
            'Stage 111 does not have ot_activation_date set', result
        )
        mock_enqueue.assert_not_called()
...
class GenerateStaleFeaturesFileTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.feature_2 = FeatureEntry(
            id=2,
            name='Stale Feature 2 (Zero notifications)',
            summary='summary',
            category=1,
            feature_type=core_enums.FEATURE_TYPE_INCUBATE_ID,
        ...
        self.feature_4 = FeatureEntry(
            id=4,
            name='Stale Feature Wrong Milestone',
            summary='summary',
            category=1,
            feature_type=1,
            owner_emails=['owner4@example.com'],
            accurate_as_of=self.long_ago,
            outstanding_notifications=5,
        )  # Added for clarity
        self.feature_4.put()
        ...
        self.feature_5 = FeatureEntry(
            id=5,
            name='Stale Feature No Shipping Stage',
            summary='summary',
            category=1,
            feature_type=0,
            owner_emails=['owner5@example.com'],
            accurate_as_of=self.long_ago,
            outstanding_notifications=5,
        )  # Added for clarity
        self.feature_5.put()
        ...
        self.feature_6 = FeatureEntry(
            id=6,
            name='Stale Feature Non-Shipping Stage',
            summary='summary',
            category=1,
            feature_type=core_enums.FEATURE_TYPE_INCUBATE_ID,
            owner_emails=['owner6@example.com'],
            accurate_as_of=self.long_ago,
            outstanding_notifications=5,
        )
        self.feature_6.put()
        ...
        self.feature_7 = FeatureEntry(
            id=7,
            name='Stale Feature 7 (None date, 1 notification)',
            summary='summary',
            category=1,
            feature_type=core_enums.FEATURE_TYPE_INCUBATE_ID,
    ...
    def test_gather_stale_features(self, mock_datetime):
        ...
        stale_features = self.handler._gather_stale_features(
    ...
    def test_get_template_data__end_to_end(
        ...
        mock_get_milestone.return_value = {
            'mstone': str(self.current_milestone)
        }
        ...
        feature_upload_call = mock_feature_blob.upload_from_string.call_args[0][
            0
        ]
        feature_reader = list(
            csv.reader(StringIO(feature_upload_call), lineterminator='\n')
        )
        ...
        expected_owners = [
            [
                str(self.feature_1.key.integer_id()),
                self.feature_1.owner_emails[0],
            ],
            [
                str(self.feature_6.key.integer_id()),
                self.feature_6.owner_emails[0],
            ],
            [
...
class GenerateShippingFeaturesFileTest(testing_config.CustomTestCase):
    ...
    @mock.patch(
        'internals.maintenance_scripts.GenerateShippingFeaturesFile._get_feature_info'
    )
    def test_generate_rows(self, mock_get_feature_info):
        ...
        f_rows, o_rows, m_rows = self.handler._generate_rows(
            [], self.current_milestone
        )
        ...
        self.assertEqual(
            f_rows[0],
            ['1', '120', 'Feature 1', 'http://example.com/1', 'complete'],
        )
        self.assertEqual(
            f_rows[1],
            ['2', '120', 'Feature 2', 'http://example.com/2', 'incomplete'],
        )
    ...
    def test_write_csv(self):
        ...
        def blob_side_effect(filename):
            ...
            if 'owners.csv' in filename:
                return mock_blob_owners
            if 'missing-criteria.csv' in filename:
                return mock_blob_missing
            return mock.MagicMock()
    ...
    @mock.patch('framework.basehandlers.FlaskHandler.require_cron_header')
    @mock.patch(
        'internals.maintenance_scripts.GenerateShippingFeaturesFile._generate_rows'
    )
    @mock.patch(
        'internals.maintenance_scripts.GenerateShippingFeaturesFile._write_csv'
    )
    def test_get_template_data(
        ...
        mock_require_cron.assert_called_once()
        mock_storage.return_value.bucket.assert_called_with(
            settings.FILES_BUCKET
        )
        ...
        self.assertEqual(
            result, '1 rows added to chromestatus-shipping-features.csv'
        )
...
class ResetStaleShippingMilestonesTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.stage_stale_wrong_type = Stage(
            id=304, feature_id=204, stage_type=150, milestones=self.milestones_3
        )
        ...
        self.stage_below_range = Stage(
            id=308, feature_id=208, stage_type=160, milestones=self.milestones_8
        )
        ...
        ndb.put_multi(
            [
                self.feature_stale_reset,
                self.stage_stale_reset,
                self.feature_boundary_reset,
                self.stage_boundary_reset,
                self.feature_stale_no_milestones,
                self.stage_stale_no_milestones,
                self.feature_stale_wrong_stage,
                self.stage_stale_wrong_type,
                self.feature_not_stale,
                self.stage_not_stale,
                self.feature_ent_rollout,
                self.stage_ent_rollout,
                self.feature_below_range,
                self.stage_below_range,
                self.feature_above_range,
                self.stage_above_range,
                self.feature_mixed_range,
                self.stage_mixed_range,
            ]
        )

    @mock.patch(
        'internals.maintenance_scripts.utils.get_current_milestone_info'
    )
    @mock.patch(
        'internals.maintenance_scripts.cloud_tasks_helpers.enqueue_task'
    )
    @mock.patch('framework.basehandlers.FlaskHandler.require_cron_header')
    def test_get_template_data__resets_stale_features_and_milestones_in_range(
        ...
        self.assertEqual(
            0, self.feature_stale_reset.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0, self.feature_boundary_reset.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0,
            self.feature_stale_no_milestones.key.get().outstanding_notifications,
        )
        ...
        self.assertEqual(
            0,
            self.feature_stale_wrong_stage.key.get().outstanding_notifications,
        )
        ...
        self.assertEqual(
            3, self.feature_not_stale.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0, self.feature_ent_rollout.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0, self.feature_below_range.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0, self.feature_above_range.key.get().outstanding_notifications
        )
        ...
        self.assertEqual(
            0, self.feature_mixed_range.key.get().outstanding_notifications
        )
...
class DeleteWPTCoverageReportTest(testing_config.CustomTestCase):
    ...
    def setUp(self):
        ...
        self.feature_none = FeatureEntry(
            id=923,
            name='No Report Feature',
            summary='summary',
            category=1,
            ai_test_eval_report=None,
            ai_test_eval_status_timestamp=old_timestamp,
        )  # Still old, but no report
    ...
    def test_get_template_data__deletes_old_reports(self, mock_datetime):
        ...
        self.assertEqual(
            updated_feature_old.ai_test_eval_run_status,
            core_enums.AITestEvaluationStatus.DELETED,
        )
        self.assertEqual(
            updated_feature_old.ai_test_eval_status_timestamp, self.mock_now
        )

        # Check Feature 922 (New) - should be untouched.
        updated_feature_new = self.feature_new.key.get()
        self.assertEqual(
            updated_feature_new.ai_test_eval_report, 'This is a new report.'
        )
        self.assertEqual(
            updated_feature_new.ai_test_eval_status_timestamp,
            self.new_timestamp,
        )
        ...
        self.assertEqual(
            updated_feature_boundary.ai_test_eval_run_status,
            core_enums.AITestEvaluationStatus.DELETED,
        )
        self.assertEqual(
            updated_feature_boundary.ai_test_eval_status_timestamp,
            self.mock_now,
        )
        ...
        self.assertEqual(
            activity_1.content,
            'WPT coverage report was deleted due to 180-day retention policy.',
        )
